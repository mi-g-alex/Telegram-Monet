...
class MainActivity : AppCompatActivity() {
    ...
    private fun shareTheme(MonetFile: String, outputFile: String, theme: String) {
        ...
        val darkThemeImport =
            application.assets.open(MonetFile).bufferedReader().readLines().joinToString()
                .replace(", ", "\n").replace("a1_0", a1_0.toString())
                .replace("a1_500", a1_500.toString()).replace("a1_50", a1_50.toString())
                .replace("a1_200", a1_200.toString()).replace("a1_300", a1_300.toString())
                .replace("a1_400", a1_400.toString()).replace("a1_600", a1_600.toString())
                .replace("a1_700", a1_700.toString()).replace("a1_800", a1_800.toString())
                .replace("a1_900", a1_900.toString()).replace("a1_1000", a1_1000.toString())
                .replace("a1_100", a1_100.toString()).replace("a1_10", a1_10.toString())
                .replace("a2_0", a2_0.toString()).replace("a2_200", a2_200.toString())
                .replace("a2_300", a2_300.toString()).replace("a2_400", a2_400.toString())
                .replace("a2_500", a2_500.toString()).replace("a2_50", a2_50.toString())
                .replace("a2_600", a2_600.toString()).replace("a2_700", a2_700.toString())
                .replace("a2_800", a2_800.toString()).replace("a2_900", a2_900.toString())
                .replace("a2_1000", a2_1000.toString()).replace("a2_100", a2_100.toString())
                .replace("a2_10", a2_10.toString()).replace("a3_0", a3_0.toString())
                .replace("a3_200", a3_200.toString()).replace("a3_300", a3_300.toString())
                .replace("a3_400", a3_400.toString()).replace("a3_500", a3_500.toString())
                .replace("a3_50", a3_50.toString()).replace("a3_600", a3_600.toString())
                .replace("a3_700", a3_700.toString()).replace("a3_800", a3_800.toString())
                .replace("a3_900", a3_900.toString()).replace("a3_1000", a3_1000.toString())
                .replace("a3_100", a3_100.toString()).replace("a3_10", a3_10.toString())
                .replace("n1_0", n1_0.toString()).replace("n1_200", n1_200.toString())
                .replace("n1_300", n1_300.toString()).replace("n1_400", n1_400.toString())
                .replace("n1_500", n1_500.toString()).replace("n1_600", n1_600.toString())
                .replace("n1_700", n1_700.toString()).replace("n1_800", n1_800.toString())
                .replace("n1_900", n1_900.toString()).replace("n1_1000", n1_1000.toString())
                .replace("n1_50", n1_50.toString()).replace("n1_100", n1_100.toString())
                .replace("n1_10", n1_10.toString()).replace("n2_0", n2_0.toString())
                .replace("n2_200", n2_200.toString()).replace("n2_300", n2_300.toString())
                .replace("n2_400", n2_400.toString()).replace("n2_500", n2_500.toString())
                .replace("n2_600", n2_600.toString()).replace("n2_700", n2_700.toString())
                .replace("n2_800", n2_800.toString()).replace("n2_900", n2_900.toString())
                .replace("n2_1000", n2_1000.toString()).replace("n2_50", n2_50.toString())
                .replace("n2_100", n2_100.toString()).replace("n2_10", n2_10.toString())
